...
describe("Home Assistant URL policy", () => {
  ...
  it("accepts URL-shaped allowlist entries and compares by hostname", () => {
    expect(parseAllowedHomeAssistantHosts("https://homeassistant.local/, other.local:8123")).toEqual(
      new Set(["homeassistant.local", "other.local"]),
    )
  })
